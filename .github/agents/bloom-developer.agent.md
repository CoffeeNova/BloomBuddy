...
3. Read repo memory: `/memories/repo/bloom-buddy.md` + topic files (`gotchas`, `decisions`, `phases`).
...
- **The core feature needs in-game verification.** The exact party/raid buff-frame paths and the Lifebloom spell IDs (`33763`/`48450`/`48451`) are marked VERIFY in `.github/` — never assume them; confirm in game or against working addons first.
